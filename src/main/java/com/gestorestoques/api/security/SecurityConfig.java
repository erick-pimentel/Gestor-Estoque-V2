    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/produtos/**").hasAnyRole("ADMINISTRADOR", "OPERADOR_DE_ESTOQUE", "GESTOR")
                        .requestMatchers("/api/fornecedores/**").hasAnyRole("ADMINISTRADOR", "OPERADOR_DE_ESTOQUE")
