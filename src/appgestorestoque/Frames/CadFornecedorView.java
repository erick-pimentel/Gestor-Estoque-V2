 ...
 * @author Ericz
 */
public class CadFornecedorView extends javax.swing.JFrame {

    private User user;
    private final FornecedorService fornecedorService;

    /**
     * Creates new form CadFornecedorView
     */
    public CadFornecedorView() {
        this(new FornecedorService());
    }

    public CadFornecedorView(FornecedorService fornecedorService) {
        this.fornecedorService = fornecedorService;
        initComponents();
        this.setTitle("Cadastro de Fornecedores -  Gestor Estoques");
    ...
    private void initComponents() {
        ...
        txt_fornecedorNome.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_fornecedorNomeActionPerformed(evt);
            }
        });
    ...
    private void btn_fornecedorExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_fornecedorExcluirActionPerformed
        try {
            String searchInput = JOptionPane.showInputDialog(this,
                    "Insira o nome, CNPJ ou ID do fornecedor a deletar:",
                    "Buscar Fornecedor", JOptionPane.QUESTION_MESSAGE);

            if (searchInput == null || searchInput.trim().isEmpty()) {
                return;
            }

            Fornecedor fornecedor = fornecedorService.buscarFornecedor(searchInput.trim());
            if (fornecedor == null) {
                JOptionPane.showMessageDialog(this,
                        "Fornecedor '" + searchInput + "' nao encontrado.",
                        "Fornecedor nao encontrado", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            fornecedorService.excluirFornecedor(searchInput.trim());
            JOptionPane.showMessageDialog(this,
    ...
    private void btn_fornecedorCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_fornecedorCadastrarActionPerformed
        try {
            String nome = normalizarCampo(txt_fornecedorNome.getText(), "Insira o nome do fornecedor");
            String cnpj = normalizarCampo(txt_fornecedorCnpj.getText(), "Insira o CNPJ do fornecedor");
            String contato = normalizarCampo(txt_fornecedorContato.getText(), "Insira o contato do fornecedor");
            String email = normalizarCampo(txt_fornecedorEmail.getText(), "Insira o E-mail do fornecedor");

            fornecedorService.cadastrarFornecedor(nome, cnpj, contato, email);
    ...
    private void btn_fornecedorEditar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_fornecedorEditar1ActionPerformed
        try {
            String searchInput = JOptionPane.showInputDialog(this,
                    "Insira o nome, CNPJ ou ID do fornecedor a editar:",
                    "Buscar Fornecedor", JOptionPane.QUESTION_MESSAGE);
            ...
            String nome = JOptionPane.showInputDialog(this, "Nome do Fornecedor:", fornecedor.nomeFornecedor());
            if (nome == null) return;

            String cnpj = JOptionPane.showInputDialog(this, "CNPJ do Fornecedor:", fornecedor.cnpjFornecedor());
            if (cnpj == null) return;

            String contato = JOptionPane.showInputDialog(this, "Contato do Fornecedor:", fornecedor.telefoneFornecedor());
            if (contato == null) return;

            String email = JOptionPane.showInputDialog(this, "Email do Fornecedor:", fornecedor.emailFornecedor());
            if (email == null) return;

            fornecedorService.editarFornecedor(searchInput.trim(), nome, cnpj, contato, email);
    ...
    private void txt_fornecedorNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_fornecedorNomeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_fornecedorNomeActionPerformed

    private String normalizarCampo(String valor, String placeholder) {
        if (valor == null) {
            return "";
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadFornecedorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadFornecedorView().setVisible(true);
            }
        });
    }
